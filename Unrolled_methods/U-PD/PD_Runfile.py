...
parser.add_argument('--train_batch_size', type=int,
                    default=15, help="training batch size")
...
train_conditions = [args.epochs, args.lr, args.train_batch_size,
                    args.val_batch_size, args.test_batch_size, args.Dataset]


Net = U_PD(Initialization, train_conditions, paths)
